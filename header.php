<html lang="en-US">
  <head>
    ...
    <a href="https://icons8.com/icon/80695/certificate"></a>
...
.timeline ul li:nth-child(even) div::before {
  ...
  border-color: transparent transparent transparent #00a6ca;
}
...
<div class="profile-page">
  <div class="wrapper">
    <div class="page-header page-header-small" filter-color="green">
      <div class="page-header-image" data-parallax="true" style="background-image: url('images/doctor.jpg')"></div>
      <div class="container">
        <div class="content-center">
          <div class="cc-profile-image"><a href="#"><img src="images/ruby.jpeg" alt="Image"/></a></div>
          <div class="h2 title">Ruby P Jacob</div>
          <p class="category text-white">Physiotherapist</p><a class="btn btn-primary smooth-scroll mr-2" href="#contact" data-aos="zoom-in" data-aos-anchor="data-aos-anchor">Hire Me</a><a download = "resume.pdf" class="btn btn-primary" href="#" data-aos="zoom-in" data-aos-anchor="data-aos-anchor">Download CV</a>
        </div>
      </div>
      <div class="section">
        <div class="container">
