        ...
        <div class="col-lg-6 col-md-12">
          <div class="card-body">
            ...
            <div class="row mt-3">
              ...
              <div class="col-sm-8">rubypjacob02@gmail.com</div>
            </div>
            <div class="row mt-3">
              <div class="col-sm-4"><strong class="text-uppercase">Mobile:</strong></div>
              <div class="col-sm-8">+91-8921147613</div>
            </div>
            <div class="row mt-3">
              <div class="col-sm-4"><strong class="text-uppercase">Address:</strong></div>
              <div class="col-sm-8">
                  Elanjickal (H), Piralassery P.O
Chengannur, Alappuzha, Kerala.
            ...
            <div class="row mt-3">
              ...
              <div class="col-sm-8">English, Hindi, Tamil, Kannada, Malayalam</div>
            </div>
          </div>
        </div>
      </div>
              ...
              <div class="row">
                ...
                <div class="col-md-6">
                  <div class="card-body">
                    ...
                    <p class="pb-2">+91-8921147613</p>
                    <p class="mb-0"><strong>Email</strong></p>
                    <p>rubypjacob02@gmail.com</p>
                  </div>
                </div>
              </div>
            </div>
